    ...
    <div class="container bg-white"> 
        <div class="row pt-3">
            <div class="col-2 col-sm-2 no-pad">
                <a href="#"><img class="img-sm rounded-circle" alt="Profile Picture" src="https://bootdey.com/img/Content/avatar/avatar1.png"></a>
                <a href="#" class="btn-link text-semibold d-flex justify-content-center">User</a>
            </div>
            <article class="col-10 col-sm-10">       
                <span data-text-id='${key}'>${text}</span>
            </article>
        </div>            
        <div class="col-12 col-sm-12 d-flex justify-content-end no-pad">
            <a class="btn btn-sm" href="#"><i class="fa fa-thumbs-up"></i></a>
            <a class="btn btn-sm" href="#"><i class="fa fa-thumbs-down"></i></a>
